...
## Orginal will be getting feed from camera
cap = cv2.VideoCapture(r"resources\traffic_car2.mp4")

## Fine tuned with Licence Plate of car YOLOv10
...
## Paddle OCR to extract from the number plate
